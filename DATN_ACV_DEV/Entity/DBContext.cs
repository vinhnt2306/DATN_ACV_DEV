...
public partial class DBContext : DbContext
{
    ...
    public virtual DbSet<TbOrderHistories> TbOrderHistories { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ADMIN\\SQLEXPRESS;Initial Catalog=DATABASE_ACV_11_01_2024;Integrated Security=True; Encrypt=False;MultipleActiveResultSets=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbOrderHistories>(entity =>
        {
            entity.HasOne(x => x.Order).WithMany(x => x.TbOrderHistories).HasForeignKey(x => x.OrderId);
        });
